...
function calculateUserPoints(userPrediction) {
    ...
    const round1Winners = ['Canes', 'Avs', 'Flyers', 'Wild', 'Ducks', 'Sabres', 'Vegas'];
    const round2Winners = [];
    const round3Winners = [];
    const finalWinner = "";
...
client.on('messageCreate', async message => {
    ...
    if (command === 'leaderboard') {
        const paidUsers = ['darrell99', 'stevechoi', 'ripkek', 'canucksfan233', 'b2water', 'supsoup', 'tobi.36', 'stickycoom', 'jrg']
